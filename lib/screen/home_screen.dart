...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<Book>> fetchPosts() async {
    final response = await http.get(Uri.parse('https://stephen-king-api.onrender.com/api/books'));
        ...
        actions: [
            IconButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MyBooksScreen()));
              },
            ), 
        ]
      ),
                ...
                return ListTile(
                  ...
                  trailing: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BookDetailScreen(bookId: book.id)));
                    },
